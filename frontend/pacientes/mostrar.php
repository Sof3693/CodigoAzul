...
<head>
    ...
    <title>Hospital| Listado de pacientes</title>
</head>
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <button class="button" onclick="reproducirAlarma()">Alerta</button>

<!-- Etiqueta de audio para cargar el sonido de alarma desde una URL externa -->
